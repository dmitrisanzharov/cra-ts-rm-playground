...
import { columns, Person, columnsPlayground } from './columnDef';

type Props = {};

const BasicTablePlayGround = (props: Props) => {
    const dataFinal: Person[] = React.useMemo(() => jsonData, [jsonData]);
    const columnsFinal = React.useMemo(() => columnsPlayground, [columnsPlayground]);
...
export default BasicTablePlayGround;
